    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
               ...
               new Product { Id = 3, CategoryId = 2, Price = 50, Stock = 175, CreatedDate = DateTime.Now, Name = "Kitap 1" },
               new Product { Id = 4, CategoryId = 2, Price = 25, Stock = 5, CreatedDate = DateTime.Now, Name = "Kitap 2" }
                );
        }
    }
}
